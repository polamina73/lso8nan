...
<div>
    ...
    <input type="text" name="phone" value="{{ old('phone', $client->phone ?? '') }}"
           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 @error('phone') border-red-400 @enderror"
...
<div>
    ...
    <textarea name="note" rows="3"
              class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 @error('note') border-red-400 @enderror"
